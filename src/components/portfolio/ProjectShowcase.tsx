    ...
    <div className="mt-10 sm:mt-14">
          ...
          {projects.map((project, index) => {
            ...
            return (
              <button
                ...
                style={isActive ? { backgroundColor: item.accent, color: item.contrast } : undefined}
              >
                {item.label}
              </button>
            );
      ...
      >
          <div className="grid gap-10 px-6 py-10 sm:px-10 sm:py-14 lg:grid-cols-[minmax(0,1.35fr)_minmax(17rem,0.65fr)] lg:gap-16 lg:px-16 lg:py-20">
            <div>
              <p className="text-sm font-semibold text-[var(--ink-secondary)]">{activeProject.period}</p>
