...
![연결 UX 개선 전](/images/case-studies/tooling-ui-flow/connection-before.png)

*Before: 포트 색이 단조로워 연결 가능 여부를 한눈에 파악하기 어려움*

**After** — 노드 타입(데이터셋·라벨링·학습 등)마다 핸들·엣지 색을 맞춰 연결 경로를 시각적으로 고정했습니다.

![연결 UX 개선 후](/images/case-studies/tooling-ui-flow/connection-after.png)
...
![렌더링 최적화 전](/images/case-studies/tooling-ui-flow/render-before.png)

*Before: 노드 수정·연결 인터랙션 시 캔버스 멈춤(100~400ms, 생성 시 ~2s)*

**After** — 동일 파이프라인에서 수정·연결이 끊기지 않습니다.

![렌더링 최적화 후](/images/case-studies/tooling-ui-flow/render-after.png)
