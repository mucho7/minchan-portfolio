...
company: "(주) 아하랩스"
summary: "파이프라인 캔버스의 연결 UX·렌더링을 개선하고\n단계·상태·결과 표현을 재정렬해 QA와 신규 사용자의 온보딩 비용을 낮췄습니다."
order: 4
period: "2024.11 - 재직중"
...
preview:
  ...
  decision: "타입별 색상 핸들로 연결 가능 여부를 표시하고,\nZustand 구독 영역을 줄여 불필요 리렌더를 제거."
  result: "생성·수정 지연을 20ms 이하로 줄이고,\nQA·개발 간의 해석 불일치를 감소시켰습니다."
---
